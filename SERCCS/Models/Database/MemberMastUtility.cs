...
{
    public class MemberMastUtility
    {
        ...
        public decimal finalsbamt { get; set; }
        public decimal finaltotamt { get; set; }
        public string cmtdno { get; set; }
        public decimal finalshamt { get; set; }
        public string cmtdamt { get; set; }
        public decimal finalcmtdamt { get; set; }
        ...
        public decimal OsCmtd { get; set; }
        public decimal SbAmt { get; set; }
        public decimal TtlShare { get; set; }
        public decimal IntCmtd { get; set; }

        public decimal TtlCmtd { get; set; }
        public decimal TtlSbAmt { get; set; }
